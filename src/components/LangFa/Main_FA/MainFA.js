    ...
    return (
        <div onClick={props.tapExitBSFunc} className={"main" + props.mainOpenBSClass} >
            ...
            <div className="main-banner">
                ...
                <h1 className={"banner-title"}>سلام محبی هستم،<br/>توسعه دهنده وب :)</h1>
            ...
            <h6 style={{margin:"30px 0 0 30px"}} className={"align-self-start p-2"} >خدمات قابل ارائه:</h6>
            <div style={{width: "90%", padding:"10px 0 30px 0"}} className={"d-flex flex-wrap justify-content-around align-content-around"} >
                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <p className="card-text">راه اندازی و پیکربندی سرویس ها، نرم افزار و وب سایت بر روی سرور، به طور ویژه سرور های لینکوسی.</p>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">وب سایت های سه بعدی</h6>
                        <p className="card-text">یک تجربه کاملا جدید! دنیایی با مدل های سه بعدی تعاملی. تصوارت و ایده های خود را به وبسایتتان بیاوریدو میتوانین کالاهای خود را به طور سه بعدی معرفی کنید :)</p>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">طراحی معماری پروژه</h6>
                        <p className="card-text">تمامی فازهای توسعه پروژه شامل طراحی و معماری کلی، رابط های کاربری، ساختار مدل ها و کامپوننت ها. همچنین مدیریت و طراحی دیتابیس های مختلف</p>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body">
